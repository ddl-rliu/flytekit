...
class BlobType(_common.FlyteIdlEntity):
    ...
    def __init__(self, format, dimensionality, file_extension="csvx", enable_legacy_filename=True):
        """
        ...
        :param Text file_extension: Optional file extension (without leading dot) used when
            materializing the blob to local disk, e.g. "csv", "parquet". Empty by default.
    ...
    def file_extension(self):
        """
        Optional file extension (without leading dot) for local materialization.
        :rtype: Text
        """
    ...
    def enable_legacy_filename(self):
        """
        When True and file_extension is set, copilot writes to both paths.
        :rtype: bool
        """
